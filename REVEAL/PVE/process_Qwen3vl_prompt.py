...
def main():
    ...
    MODEL_PATH = "Qwen/Qwen3-VL-8B-Instruct" # Qwen3-VL-4B-Instruct / Qwen3-VL-8B-Instruct / Qwen3-VL-32B-Instruct
    ...
    SAVE_PATH = os.path.join(SAVE_DIR, "qwen3vl_prompt_image_features.pt")
